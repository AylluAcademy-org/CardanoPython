...
class Wallet(Cardano):
    ...
    def wallet_info(self, id):
        ...
        Return json with status of the wallet with info like lovelace and
            assets balance, delegation status, etc"""
    ...
    #     Inputs: Id of the wallet
    #             data with details of the transactio like metadata, address to,
    #             amount, etc
    ...
    def assets_balance(self, *args, **kwargs):
        """ List all assets associated with the wallet, and their metadata if
            known.
            An asset is associated with a wallet if it is involved in a
